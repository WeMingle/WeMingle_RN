    ...
    <BaseSafeView>
      ...
      <RowBox alignC style={{}}>
        <MatchingListTab
          ...
          style={selectedTab === 1 ? SelectedStyle : NonSelectedStyle}>
          <CommonText color={selectedTab === 1 ? '#212121' : Colors.c_gray500}>
            매칭
          </CommonText>
        </MatchingListTab>
        <MatchingListTab
          onPress={() => setSelectedTab(2)}
          style={selectedTab === 2 ? SelectedStyle : NonSelectedStyle}>
          <CommonText color={selectedTab === 2 ? '#212121' : Colors.c_gray500}>
            히스토리
          </CommonText>
        </MatchingListTab>
      </RowBox>
