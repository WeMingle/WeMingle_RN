...
export const DropdownMenu = ({menuTitle, marginL}: DropdownMenuProps) => {
  return (
    <BorderBox
      row
      alignC
        ...
        renderItem={({item, index}) => {
          return (
            <MatchingBorderBox>
              ...
              <CommonText marginT={3} fontSize={12} color={Colors.c_gray500}>
                [3월 24일 신입생들과 경기 매칭하실 학교 구합니다.]
              </CommonText>
              <CommonText marginT={7} fontSize={12} color={Colors.c_gray500}>
                2024.02.24
              </CommonText>
            </MatchingBorderBox>
          );
          ...
          return (
            <MatchingBorderBox>
              ...
              <RowBox marginT={20}>
                ...
                <BorderBox
                  borderColor={item === 2 ? Colors.c_gray500 : '#fff'}
                  marginL={10}
                  bgColor={
                    item === 1
                      ? Colors.c_gray300
                  ...
                  style={{flex: 0.8}}
                  alignC>
                  <CommonText color={item === 2 ? Colors.c_gray500 : '#fff'}>
                    취소할 수 있는 기간이 아닙니다.
                  </CommonText>
                </BorderBox>
              </RowBox>
        ...
        <ShadowBox width={146} height={146}>
          <ShadowContainer width={145} height={145}>
            <TouchableOpacity onPress={onPressFirst}>
              <CommonText fontSize={14}>내정보 수정</CommonText>
            </TouchableOpacity>
            <TouchableOpacity onPress={onPressSecond}>
              <CommonText fontSize={14}>비밀번호 및 보안</CommonText>
            </TouchableOpacity>
            <TouchableOpacity onPress={onPressThird}>
              <CommonText fontSize={14}>로그아웃</CommonText>
            </TouchableOpacity>
          </ShadowContainer>
        </ShadowBox>
      </ConfigFrameContainer>
